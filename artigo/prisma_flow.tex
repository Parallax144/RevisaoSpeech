...
\node[ebox, right=2.2cm of screen] (excl1) {
  ...
  {\scriptsize
    Sem PLN/ASR de interações clínicas (EC1): 480\\
    Transcrição sem análise de interação (EC2): 194\\
    Editoriais, resumos, opinião (EC4): 50
  }
};
...
\node[ebox, right=2.2cm of eligib] (excl2) {
  ...
  {\scriptsize
    Sem PLN/ASR de interações clínicas (EC1): 8\\
    Transcrição sem análise de interação (EC2): 5\\
    Editoriais, opinião, sem dados empíricos (EC4): 4\\
    Radford 2023 (ref.\ tecnológica; EC1): 1
  }
};
