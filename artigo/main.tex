...
%% REVISAR [Murilo]: checar IC/EC de cada linha antes da submissão.
%%   ‡ = preprint / não peer-reviewed — confirmar IC4 e política IJMI para preprints.
...
%% aos artigos originais antes da submissão. Krishna 2021 e Schloss 2020
%% são preprints — confirmar IC4 e política IJMI para preprints.
...
%% aos artigos originais antes da submissão.
...
%% REVISAR [Fabrício]: verificar se os dados reportados correspondem
%% aos artigos originais. Albert 2024 é preprint (medRxiv) — confirmar IC4.
...
%% REVISAR [todos]: confirmar se outras ferramentas de IA foram usadas (DeepL,
%%   ChatGPT etc.) e acrescentar aqui conforme Política GenAI da Elsevier.
