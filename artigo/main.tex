...
%% CONTAGENS PRELIMINARES (busca de calibração, jun/2026):
%% PubMed com string completa (3 blocos): 8 registros — string restritiva,
%% recomenda-se testar pares de blocos para ampliar o pool.
%% IEEE Xplore, ACM DL, Scopus e WoS requerem acesso institucional USF;
%% estimativas: IEEE ~50–200, ACM ~20–80, Scopus ~150–400, WoS ~100–300.
%% TODO [Murilo]: executar buscas com login institucional e registrar n exato
%% por base antes de preencher os [N] abaixo.
