...
\begin{itemize}
  ...
  \item \textbf{EC5:} Texto completo indisponível sem pagamento ou inacessível
        por canais institucionais.
  \item \textbf{EC6:} Estudos que não descrevem coleta de dados, metodologia de
        processamento ou validação técnica.
  \item \textbf{EC7:} Pesquisas que abordem exclusivamente interações não clínicas
...
%% κ = 0,78 (F.E.S. e M.M.; kappa de Cohen — triagem dupla-cega no Rayyan)
