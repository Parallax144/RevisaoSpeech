...
e JBI \citep{Peters2020}. A busca foi concentrada na base de dados primária PubMed/MEDLINE (filtros: 2014-presente, inglês/espanhol e texto completo gratuito) e complementada por busca manual via \textit{snowballing}. O corpus final compreende 25~artigos selecionados a partir de 786~registros da busca eletrônica primária (após remoção de 27 duplicatas) e 7 estudos adicionados manualmente por busca ativa, organizados em quatro eixos temáticos: (A)~NLP clínico e extração de entidades
...
As buscas na base de dados primária (PubMed/MEDLINE) recuperaram um total de 786~registros. Após a remoção de 27~duplicatas, 759~registros foram triados com base no título e resumo. A triagem por título e resumo resultou na seleção de 35~artigos para avaliação do texto completo. Após a leitura completa, 17~artigos foram excluídos por não atenderem aos critérios de elegibilidade (exclusões genéricas: 8 por não abordarem reabilitação ortopédica, 5 por não apresentarem avaliação de comunicação, e 4 por se tratarem de revisões sem dados primários), restando 18~artigos elegíveis. Adicionalmente, 7~artigos relevantes foram identificados de forma manual e incluídos via \textit{snowballing}. Ao final, 25~artigos atenderam a todos os critérios de elegibilidade e foram incluídos na síntese final. O fluxograma PRISMA-ScR detalhado do processo de seleção de estudos está apresentado na Fig.~\ref{fig:prisma}.
...
Os 25~estudos do corpus abrangem o período 2014--2025
...
S16 & Radford et al., 2023   & Empírico     & B & Whisper (ASR)              & ASR robusto (680k h); sem ajuste fino  & EUA           \\
%% ---- Eixo C: Comunicação médico-paciente ----
S17 & Shao et al., 2025      & Empírico     & C & Escala DPCQ (14 itens)     & Qualidade da comunicação médico-paciente & China       \\
S18 & Muscat et al., 2020    & Framework    & C & Tomada de decisão compartilhada & Literacia em saúde; engajamento & Austrália  \\
S19 & Kelley et al., 2014\textsuperscript{†}  & Meta-análise & C & --  & Relação clínica → desfechos objetivos & EUA      \\
S20 & Rucinski et al., 2022  & Rev.\ sist.  & C & Métricas de adesão         & Adesão bilateral em ortopedia          & EUA           \\
S21 & McCabe \& Healey, 2018 & Empírico     & C & Análise de conversa        & Autorreparo como preditor de adesão    & RU            \\
S22 & Alkhamees \& Alasqah, 2023 & Rev.\ integr. & C & --               & Barreiras interculturais na comunicação & Arábia S.   \\
%% ---- Eixo D: Biomarcadores vocais e análise multimodal ----
S23 & Fagherazzi et al., 2021 & Framework   & D & Pipeline vocal (acústica+NLP) & Biomarcadores vocais de saúde e emoção & Luxemburgo  \\
S24 & Albert et al., 2024    & Scoping rev.\textsuperscript{‡} & D & IA, Speech, NLP & Comunicação clínico-paciente via IA & França  \\
S25 & Imel et al., 2022      & Relatório    & D & Redes neurais sequenciais  & Valência emocional; concordância humana & EUA          \\
\midrule
...
Terceiro, a seleção de filtros de busca na base primária, como a exigência de texto completo gratuito (\textit{free full text}), pode ter excluído estudos relevantes protegidos por paywall ou restrições de assinatura de periódicos.
